...
return [
    'ctrl' => [
        ...
        'searchFields' => 'date,article_name,article_description,article_content,article_optional_field_one,article_optional_field_two,article_optional_field_three',
        'iconfile' => 'EXT:article/Resources/Public/Icons/tx_article_domain_model_article.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, date, article_name, article_description, article_content, article_optional_field_one, article_optional_field_two, article_optional_field_three',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, date, article_name, article_description, article_content, article_optional_field_one, article_optional_field_two, article_optional_field_three, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
