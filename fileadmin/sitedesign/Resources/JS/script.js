...
$(document).ready(function(){
    $(window).scroll(function() {
        if ($(document).scrollTop() > 50) {
            $("#logo").attr("src", "http://localhost/Espetada/fileadmin/user_upload/images/Logo_stick.png")
        }
        else {
             $("#logo").attr("src", "http://localhost/Espetada/fileadmin/user_upload/images/Logo_main.png")
        }
    });
});
/*=================================================================
